# Generated by Django 5.2.1 on 2025-08-04 19:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='job_portal.employerprofile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_seeker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_alerts', to='job_portal.jobseekerprofile')),
            ],
        ),
        migrations.CreateModel(
            name='JobApplication',
            fields=[
                ...
                ('applicant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='job_portal.jobseekerprofile')),
            ],
            options={
                'ordering': ['-applied_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_seeker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='saved_jobs', to='job_portal.jobseekerprofile')),
            ],
            options={
                'ordering': ['-saved_at'],
